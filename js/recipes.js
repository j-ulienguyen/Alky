var recipes = {
    ...
    happy:{
        ...
        medium: {
            ...
            ingredients: [
                "400ml Korean Soju",
                "2 100ml Bottles of Yakult or Cultured Yogurt Drink (Original Flavour)",
                "50ml 7-Up or Sprite , or to taste",
                "Ice Cubes"
            ],
            instructions: [
                "You will need a glass pitcher, soju shot glasses and a stirrer",
    ...
    fatigue: {
        light: {
            ...
            instructions: [
                "In a Georgian Irish Coffee mug, add the scoop of ice cream.",
        ...
        hard: {
            ...
            instructions: [
                ...
                "Add Kahlua and vodka to the glass.",
    ...
    stressed: {
        ...
        medium: {
            ...
            instructions: [
                ...
                "Combine all the ingredients in a high powered blender and pulse until fully combined and smooth.",
        ...
        hard: {
            ...
            instructions: [
                "Never shake a Negroni, regardless of what’s at the base.",
                "Stir, stir, stir.",
    ...
    goingout: {
        light: {
            ...
            instructions: [
                ...
                "Dip into kosher salt on a plate to rim glass.",
                "Pour limeade concentrate, club soda, tequila and raz-beer-rita in a pitcher.",
        ...
        medium: {
            ...
            ingredients: [
                "1 ½ ounces Vodka (Ultimat)",
                "½ ounce​ Orange Liqueur (Patron Citronge)",
    ...
    birthday: {
        light: {
            ...
            instructions: [
                "In a medium bowl, combine St-Germain liqueur and superfine sugar.",
                "Whisk together until sugar dissolves.",
                "Add green grapes, tangerines, and ruby red grapefruit; toss to combine.",
        ...
        medium: {
            ...
            instructions: [
                "Wet the rim of a shot glass with a lemon wedge.",
                "Roll the rim in sugar and set aside.",
    ...
    relaxing: {
        ...
        hard: {
            ...
            instructions: [
                "Add all ingredients, sans garnishes, to a shaker tin with ice.",
                "Shake.",
    ...
    gamenight: {
        ...
        hard: {
            ...
            instructions: [
                ...
                "Add the ice and stir with a bar spoon for 10 to 15 seconds.",
